...
namespace ecs
{
    ...
    enum EntityTypes { SPACESHIP, MONSTER, SHOT, BUTTON, WALL, BACKGROUND, PARALLAX, ROOM, ROOMID, ROOMMODE, ROOMPLANETINFO, ROOMHIGHSCORE, ROOMPLAYERSNAME, SHAPE, TEXT, TEXTBOX, TEXTBOXNUMBER, PSEUDO, MUSIC, SFX };
