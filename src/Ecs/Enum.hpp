...
namespace ecs
{
    ...
    enum EntityTypes { SPACESHIP, MONSTER, BASIC_MONSTER, SHOT, BASIC_SHOT, BUTTON, WALL, BACKGROUND, ROOM, ROOMID, SHAPE, TEXT, TEXTBOX, TEXTBOXNUMBER, ROOMMODE, PSEUDO, MUSIC, SFX };
} // namespace ecs
