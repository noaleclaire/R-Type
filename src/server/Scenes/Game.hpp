...
class Game : public ScenesInitializer {
    public:
         ...
         * @param level
         */
        static void initScene(ecs::Registry &registry, ecs::Scenes scene, std::vector<std::pair<udp::endpoint, bool>> &clients_endpoint)
        {
        ...
        static void getScene(CustomServer *server, ecs::Registry &registry, ecs::Scenes scene, std::vector<std::pair<udp::endpoint, bool>> &clients_endpoint, udp::endpoint target_endpoint, LevelManager &level)
        {
            std::size_t entity;
