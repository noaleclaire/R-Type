...
namespace ecs
{
    ...
    class SparseArray {
        ...
        public:
            ...
            reference_type emplace_at(size_type idx, Params &&... args)
            {
                ...
                {
                    throw ExceptionIndexComponent("Cannot emplace this component, bad index", "template <class... Params> reference_type emplace_at(size_type idx, Params &&...)");
                }
            } // optional
